                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group mt-3 ">
                                        <!-- <label for="status" class="from-control-label fw-bold">status</label> -->
                                        <!-- <input type="number" name="status" class="form-control" id="" placeholder="Enter product qty" value="1" style="display: none;"> -->
                                    </div>
                                    <div class="form-group mt-3 ">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <div class="form-group mt-3">
                                        <button type="submit" name="submit" class="form-control">Publise</button>
                                    </div>
                                </div>
                            </div>
                        </div>
